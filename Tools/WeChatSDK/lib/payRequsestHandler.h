...
#define APP_ID          @"wxfde7131ac33c92f5"               //APPID
#define APP_SECRET      @"52ef2537de1868dcb0526a00343002ac" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1274774801"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"3wfs4esfga321swed432esafy54321sx"
//支付结果回调页面
