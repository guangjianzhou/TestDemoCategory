...
- (NSMutableArray *)processStructuredAppend:(NSMutableArray *)results {
  ...
  [saResults sortUsingComparator:^NSComparisonResult(ZXResult *a, ZXResult *b) {
    int aNumber = [(NSNumber *)a.resultMetadata[@(kResultMetadataTypeStructuredAppendSequence)] intValue];
    int bNumber = [(NSNumber *)b.resultMetadata[@(kResultMetadataTypeStructuredAppendSequence)] intValue];
    if (aNumber < bNumber) {
