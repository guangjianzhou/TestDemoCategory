...
pod 'DTCoreText', '~> 1.6.15'               #一个功能十分强大的文字效果代码类库,在UITextView上实现十分丰富的文字效果，包括文字大小、颜色、字体、下划线，链接，给文字加     上图片、视频，文字任意间距等等。实现类似于CSS网页的文字效果
...
#夜间模式
pod 'DKNightVersion', '~> 2.3.0'


#导航栏透明效果 https://github.com/diegoserranoa/DSTransparentNavigationBar
