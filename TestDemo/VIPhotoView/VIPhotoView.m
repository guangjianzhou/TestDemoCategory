...
//    [_containerView addGestureRecognizer:tapGestureRecognizer];
    ...
    //旋转
    UIRotationGestureRecognizer *rotateRecognize = [[UIRotationGestureRecognizer alloc] initWithTarget:self action:@selector(roteGesImagView:)];
    rotateRecognize.delegate = self;
    [_containerView addGestureRecognizer:rotateRecognize];
...
- (void)roteGesImagView:(UIRotationGestureRecognizer *)recognizer
{
