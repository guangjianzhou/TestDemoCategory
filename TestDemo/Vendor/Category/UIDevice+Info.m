...
{
    NSString *deviceClass = [self getDeviceAndOSInfo];
    //    NSLog(@"deviceClass = %@",deviceClass);
    ...
    NSString *deviceString = [iOSDevices valueForKey:deviceClass];
    return deviceString.length>0?deviceString:deviceClass;
}
